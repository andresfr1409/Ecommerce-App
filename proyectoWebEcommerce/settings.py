"""
Django settings for proyectoWebEcommerce project.
...
SECRET_KEY = 'django-insecure-b)nyi@@!r-3278m7h_hq8s=+=8-x!!v(9!_9ae)_k*+ad$8g41'
...
ROOT_URLCONF = 'proyectoWebEcommerce.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'CarroCompras.context_processor.total_carrito',
                'CarroCompras.context_processor.cantidad_productos_carrito',
            ],
        },
    },
]

WSGI_APPLICATION = 'proyectoWebEcommerce.wsgi.application'
